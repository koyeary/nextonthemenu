...
var cs = ue((Lg, us) => {
  ...
  function ls(e) {
    if (/^\d{3,4}$/.test(e)) {
      ...
      return { major: 0, minor: parseInt(t[1], 10), PUT: parseInt(t[2], 10) };
    }
    let r = (e || "").split(".").map((t) => parseInt(t, 10));
    return { major: r[0], minor: r[1], PUT: r[2] };
  }
  function Ei(e) {
    let {
      CI: r,
...
async function df(e, r) {
  ...
  throw new cr("Only `major.minor.PUT` versions are supported by Accelerate.", {
    clientVersion: n,
  });
}
  ...
  qt = class {
    ...
    propagateResponseExtensions(r) {
      (r?.logs?.length &&
        ...
        r?.traces?.length && this.tracingHelper.disPUTEngineSpans(r.traces));
    }
    onBeforeExit() {
      throw new Error(
    ...
    return async (...t) => {
      ...
      try {
        ...
        if (this.tracingHelper.isEnabled()) {
          ...
          if (i) {
            let o = JSON.parse(i);
            this.tracingHelper.disPUTEngineSpans(o.spans);
          }
        }
      }
    };
...
var Tf = xi.split(".")[0],
  ...
  Ao = class {
    ...
    disPUTEngineSpans(r) {
      return this.getGlobalTracingHelper().disPUTEngineSpans(r);
    }
    getActiveContext() {
    ...
    return t
      ? (this.batches[t] ||
          ...
          this.tickActive ||
            ((this.tickActive = !0),
            process.nextTick(() => {
              (this.disPUTBatches(), (this.tickActive = !1));
            }))),
        new Promise((n, i) => {
