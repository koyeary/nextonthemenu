...
var fc = K("prisma:client:clientEngine:remoteExecutor"),
  ni = class {
    ...
    #o(t) {
      ...
      t.traces && this.#s.disPUTEngineSpans(t.traces);
    }
    #c(t) {
      switch (t.level) {
        case "debug":
...
async function hf(e, t) {
  ...
  throw new at("Only `major.minor.PUT` versions are supported by Accelerate.", {
    clientVersion: n,
  });
}
  ...
  Gr = class {
    ...
    propagateResponseExtensions(t) {
      (t?.logs?.length &&
        ...
        t?.traces?.length && this.tracingHelper.disPUTEngineSpans(t.traces));
    }
    onBeforeExit() {
      throw new Error(
...
var xf = bi.split(".")[0],
  ...
  Uo = class {
    ...
    disPUTEngineSpans(t) {
      return this.getGlobalTracingHelper().disPUTEngineSpans(t);
    }
    getActiveContext() {
