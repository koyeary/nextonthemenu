    ...
    ? "normal" == a.papertype
      ...
      : "black_mark" == a.papertype
        ...
        : "black_mark_and_detect_at_power_on" == a.papertype
          ...
          : "gap" == a.papertype
            ? (b += ' papertype="gap"')
            : "gap_and_detect_at_power_on" == a.papertype &&
              (b += ' papertype="gap_and_detect_at_power_on"')
    : "normal" == this.papertype
      ...
      : "black_mark" == this.papertype
        ...
        : "black_mark_and_detect_at_power_on" == this.papertype
          ...
          : "gap" == this.papertype
            ? (b += ' papertype="gap"')
            : "gap_and_detect_at_power_on" == this.papertype &&
              (b += ' papertype="gap_and_detect_at_power_on"');
  void 0 != a.holdprint_timeout
...
StarWebPrintTrader.prototype.isRollPositionError = function (a) {
  return parseInt(a.traderStatus.substr(10, 2), 16) & 32 ? !0 : !1;
};
